<template>
  <div class="prose">
    ...
    <div class="userstory">
      ...
      <strong>wil ik</strong> een dialoog zien waar ik mijn e-mail adres kan invullen<br/>
    ...
    <button @click="showModal" class="button" aria-label="Open de dialoog">Open</button>
    ...
    <div class="modal" :class="modalIsOpen ? 'show' : ''">
      ...
      <div class="modal-footer mt-auto">
        ...
        <button ref="closeButton" @click="closeModal" class="button ml-auto">Sluiten</button>
      </div>
    </div>

    <hr />
    <router-link to="/opdracht-1" class="button mt-8">Terug naaar&nbsp;<strong>Opdracht 1</strong></router-link>
  </div>
</template>
