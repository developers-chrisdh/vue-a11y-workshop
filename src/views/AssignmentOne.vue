<template>
  <div class="prose">
    <h1>Opdracht 1: "Toegankelijke modal"</h1>
    ...
    <ul>
      <li>
        Bij het openen van de modal moet de focus gegeven worden aan TODO welk
        element?
      </li>
      <li>
        Na het sluiten van de modal moet de focus teruggegeven worden naar het
        element dat hem opent
      </li>
